 ...
 /* Get student detail by id*/
  ...
  createStudent(){
    if(this.studentID!='' && this.studentID!=undefined){
      this.studentData['id_edited'] = JSON.parse(localStorage.getItem('currentUser'))[0].member_id;
      ...
      this.studentData['id_added'] = JSON.parse(localStorage.getItem('currentUser'))[0].member_id;
      this.studentData['is_active'] = 0;
      //console.log(this.studentData);
